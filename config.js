...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY DARK HACKER  ♥️☺️*",
...
STICKER_NAME: process.env.STICKER_NAME || "DARK HACKER ",
...
OWNER_NAME: process.env.OWNER_NAME || "*DARK HACKER Official*",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ DARK HACKER Official ❣️*",
// add bot owner name    
